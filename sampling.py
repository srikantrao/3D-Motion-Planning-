...
class Sampler:
    ...
    def sample(self, grid_start, grid_goal, num_samples):
        ...
        zvals = np.full(num_samples, TARGET_ALTITUDE)
        samples = list(zip(xvals, yvals, zvals))

        # Start off with the grid_start and grid_goal points in the Graph.
        pts = [grid_start,grid_goal]
        for s in samples:
            in_collision = False
